...
origin_hostname     = "origin.alakhani.net" # Origin Hostname
edgeHostname        = "alakhani.net.edgekey.net" # Akamai Edge Hostname you want to use, ending in *.akamaized.net, *.edgesuite.net or *.edgekey.net.
certificate         = 198096 # Enrollment ID: Required only when creating an Enhanced TLS edge hostname. 
...
configuration_name   = "terraform-alakhani.net"
hostname            = "alakhanis.net"
